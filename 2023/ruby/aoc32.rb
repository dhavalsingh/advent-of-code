sample = "........936..672.........846.922........359...332......582..856........................579..93......674..740.....243.156....................
...........%.........4=...*...*........*.......*......#....................806..481.........................*.......*.........900......$564.
...
# sample = "your very long input string"
sample_2 = "467..114..
...*......
..35..633.
......#...
...
# line_number => [index] of symbols
symbol_map = {}

# Identifying symbols in the schematic
...
def is_adjacent_to_symbol?(symbol_map, line_index, index, total_lines, line_length)
  count = 0
  (-1..1).each do |row_offset|
    (-1..1).each do |col_offset|
      ...
      next if adjacent_row < 0 || adjacent_row >= total_lines || adjacent_col < 0 || adjacent_col >= line_length

      count = count + 1 if symbol_map[adjacent_row]&.include?(adjacent_col)
    end
  end
  count
end

# Identifying and summing the numbers adjacent to symbols
lines.each_with_index do |line, line_index|
  last_index = 0
  line.scan(/\d+/) do |number|
    number_start_index = line.index(number, last_index)
    last_index = number_start_index + number.length
    number_end_index = last_index - 1

    number_adjacent_to_symbol = (number_start_index..number_end_index).any? do |index|
      is_adjacent_to_symbol?(symbol_map, line_index, index, total_lines, line.length)
    end

    sum += number.to_i if number_adjacent_to_symbol
  end
end
